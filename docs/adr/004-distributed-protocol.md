...
## 状态
**已归档（Archived）** — 该 ADR 描述的是 v0.1.x 的分布式节点设想。网络层与分布式协议已在 v0.2.0 移除，当前实现为单进程库 + CLI。若未来重新引入分布式能力，需重新评估本 ADR。

> **历史版本说明**：本文档描述的是 Trit-Core v0.1.x 的分布式协议设计。`src/net/`、`ResonanceBus`、节点协议相关代码已在 v0.2.0 移除。
