# Trit-Core MVP Roadmap (v0.1.0 归档)

> **历史版本说明**：本文档是 Trit-Core v0.1.0 的路线图快照，已归档保留。v0.2.0 移除了网络层与分布式节点协议，当前路线图请参见 `docs/explanation/roadmap.md`。
...
- [x] `docs/reports/validation-report.md` summarizing findings
...
- [x] `docs/archive/technical-whitepaper.md` finalized
- [x] `docs/adr/` complete with 3 ADRs
- [x] Preprint markdown (10–15 pages) in `docs/archive/preprint.md`
