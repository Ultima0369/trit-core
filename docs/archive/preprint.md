...
> **Historical Note**: This document describes the v0.1.x architecture of Trit-Core. The network layer (`src/net/`, `ResonanceBus`, distributed node protocol) was removed in v0.2.0. For the current API and module structure, see `docs/reference/api.md`, `docs/reference/MODULES.md`, and `docs/explanation/ARCHITECTURE.md`.
