...
> **历史版本说明**：本报告审计的是 Trit-Core v0.1.0。v0.2.0 已移除网络层并重构核心模块。当前架构状态请参考 `docs/explanation/ARCHITECTURE.md` 与 `audit_log/08_reflexive_audit.md`。
...
| 契约优先 | 已有 `docs/reference/api.md` ✅ | 补充 OpenAPI YAML |
