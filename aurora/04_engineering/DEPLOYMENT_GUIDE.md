...
> **⚠️ 愿景部署形态（M3，未实现）**：当前工作区仅有 `trit-core` / `aurora` / `aurora-desktop` 三 crate，**无 `aurora-server`**。本节 docker 镜像与团队服务器为 M3 愿景设计，当前未落地。单用户部署见 §一。
...
*本文档为 Aurora 的部署指南。完整部署脚本见 GitHub 仓库。*
