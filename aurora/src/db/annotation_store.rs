//! SQLite-backed implementation of the RelationshipAnnotation BC's AnnotationStore trait.
//!
//! Stores contacts, frame annotations, and annotation history in SQLite tables.

use crate::bc::relationship_annotation::{
    AnnotationChange, AnnotationStore, ContactProfile, FrameAnnotation, RelationLabel,
};
