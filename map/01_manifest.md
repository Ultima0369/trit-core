...
| 文件 | 位置 | 语言 | 关键内容 |
|---|---|---|---|
| [[AURORA_MANIFEST]] | `aurora/00_manifest/AURORA_MANIFEST.md` | 中文 | Aurora 应用的存在理由：本地优先、数据主权、工具而非代理。 |
...
| [[SECURITY_MODEL]] | `aurora/03_whitepaper/SECURITY_MODEL.md` | 中文 | 安全模型：AES-256-GCM + 零知识架构。 |
